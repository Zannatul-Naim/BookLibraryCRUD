...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="post">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control" required value="<?php echo $book->title ?>">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="author" class="col-sm-2 col-form-label">Author's Name</label>
                <div class="col-sm-10">
                    <input type="text" name="author" id="author" class="form-control" required value="<?php echo $book->author ?>">
                </div>
            </div>
            <div class="mb-3 row">
    ...
    <div class="col-sm-10">
        <select name="available" id="availability" class="form-select" required>
            <option value="Yes" <?php if ($book->available === 'Yes') echo 'selected'; ?>>Yes</option>
            <option value="No" <?php if ($book->available === 'No') echo 'selected'; ?>>No</option>
        </select>
    </div>
</div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" name="pages" id="pages" class="form-control" required value="<?php echo $book->pages ?>">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="isbn" class="col-sm-2 col-form-label">ISBN No.</label>
                <div class="col-sm-10">
                    <input type="number" name="isbn" id="isbn" class="form-control" required value="<?php echo $book->isbn ?>">
                </div>
            </div>
